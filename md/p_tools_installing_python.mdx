...
-   Into the terminal window type `python --version` and press
    **Enter**.
...
### Step 2: Download Python 3.12.0 {#step-2-download-python-3.12.0}

-   Open your web browser.
-   Go to [Google](https://www.google.com) and search for **“Python
    3.12.0”**.
...
### Step 2: Download Python 3.12.0 {#step-2-download-python-3.12.0-1}
...
### Step 3: Install Python 3.12.0 {#step-3-install-python-3.12.0}
