...
-   `Cmd + Enter` (Mac) or `Ctrl + Enter` (Windows/Linux) to run the
    code chunk.
...
-   `pdf`: Renders the document as a PDF. You will need to have LaTeX
    (or tinytex) installed on your computer to use this format.
