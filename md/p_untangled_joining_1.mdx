...
## pd.merge() syntax {#pd.merge-syntax}
...
`test_info`. So the merge function assumes `on='name'`:
...
<figure>
<img src="images/left_join1.gif" alt="Left Join" />
<figcaption aria-hidden="true">Left Join</figcaption>
</figure>
...
[WHO](https://www.who.int/data/gho/data/indicators/indicator-details/GHO/incidence-of-tuberculosis-(per-100-000-population-per-year)):
...
<figure>
<img src="images/right_join.gif" alt="Right Join" />
<figcaption aria-hidden="true">Right Join</figcaption>
</figure>
...
<figure>
<img src="images/inner_join.gif" alt="Inner Join" />
<figcaption aria-hidden="true">Inner Join</figcaption>
</figure>

Note that the default join type is `inner`. So if you don’t specify
`how='inner'`, you’re actually performing an inner join! Try it out:
...
<figure>
<img src="images/full_join.gif" alt="Outer Join" />
<figcaption aria-hidden="true">Outer Join</figcaption>
</figure>
...
<figure>
<img src="images/venn_cropped-01.jpg" alt="Join Types" />
<figcaption aria-hidden="true">Join Types</figcaption>
</figure>
