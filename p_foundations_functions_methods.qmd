...
1. Call the `replace()` method on the string "Helo" to replace the single l with two ls.
...
input_pdf = "/Users/kendavidn/Dropbox/Mac (2)/Downloads/Certificates 19Sep2024.pdf"
...
students = [
    ...
    "Loureen Valyne",
    "Nuneaton Ramesar",
    "Toheeb Olanrewaju Sarafadeen",
    "Rajkumar Rajendram",
    "Abdeldjalil Belkheir",
    "Eman Elafef",
    "Yopa Abraham",
    "Augustine Alie",
    "Sarah Macklin",
...
# Certificate name (you can modify this as needed)
certificate_name = "FOSSA Certificate"

# Create output directory if it doesn't exist
output_dir = "/Users/kendavidn/Dropbox/Mac (2)/Downloads/split_certificates"
os.makedirs(output_dir, exist_ok=True)

# Open the input PDF
pdf_reader = PdfReader(input_pdf)

# Iterate through pages and save each as a separate file
for i, student in enumerate(students, start=1):
    pdf_writer = PdfWriter()
    pdf_writer.add_page(pdf_reader.pages[i-1])
    
    # Create output filename
    output_filename = f"{student} - {certificate_name}.pdf"
...
print("All certificates have been split and saved.")
