...
In our previous lessons, you've learned how to extract summary statistics from groups using `groupby()` and `agg()`. Now, we'll take a step further by exploring some additional useful **grouped data transformations**. So let's get started. 
