...
Use the `counties` dataset to calculate the percentage of foreign-born residents in each county. The variable `foreign_born_num` shows the number of foreign-born residents and `pop_20` shows the total population.
